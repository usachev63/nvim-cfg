...
local tex_keymap = require 'u63_legacy.toolkit.tex.keymap'
local tex_sakls = require 'u63_legacy.toolkit.tex.sakls'
...
---Initialize g:u63_latex_template vim global variable
...
local function init_template(template_path)
  ...
  g.u63_latex_template = template_file:read 'a'
end
