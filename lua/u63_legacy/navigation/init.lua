...
local telescope = require 'u63_legacy.navigation.telescope'
local u_nvim_tree = require 'u63_legacy.navigation.nvim_tree'
local u_nnn = require 'u63_legacy.navigation.nnn'
