...
---@class Options
---
---Options for usachev63-nvim-cfg.
---
...
---Default usachev63-nvim-cfg options.
---
---@type Options
local default_options = {
  editing = {
    ...
    sakls = {
      enabled = false,
      sakls_nvim_path = 'usachev63/sakls.nvim',
      options = {},
    },
  },
  key = {
...
---Handle usachev63-nvim-cfg options provided by the user.
---
...
function M.init(opts)
  ...
  if type(opts) ~= 'table' then
    error('[usachev63.options] init called with non-table second argument!', 3)
  end
